...
class OperationsRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_figi", b"_figi", "_from", b"_from", "_state", b"_state", "_to", b"_to", "figi", b"figi", "from", b"from", "state", b"state", "to", b"to"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_figi", b"_figi", "_from", b"_from", "_state", b"_state", "_to", b"_to", "account_id", b"account_id", "figi", b"figi", "from", b"from", "state", b"state", "to", b"to"]) -> None: ...
    @typing.overload
...
class PortfolioRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_currency", b"_currency", "currency", b"currency"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_currency", b"_currency", "account_id", b"account_id", "currency", b"currency"]) -> None: ...
...
class GetBrokerReportRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_page", b"_page", "page", b"page"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_page", b"_page", "page", b"page", "task_id", b"task_id"]) -> None: ...
...
class PortfolioSubscriptionResult(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["accounts", b"accounts", "stream_id", b"stream_id", "tracking_id", b"tracking_id"]) -> None: ...
...
class GetOperationsByCursorRequest(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_to", b"_to"]) -> typing_extensions.Literal["to"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_without_commissions", b"_without_commissions"]) -> typing_extensions.Literal["without_commissions"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_without_overnights", b"_without_overnights"]) -> typing_extensions.Literal["without_overnights"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_without_trades", b"_without_trades"]) -> typing_extensions.Literal["without_trades"] | None: ...
