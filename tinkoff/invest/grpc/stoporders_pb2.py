...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _POSTSTOPORDERREQUEST.fields_by_name['quantity']._serialized_options = b'\340A\002'
  _POSTSTOPORDERREQUEST.fields_by_name['direction']._options = None
  _POSTSTOPORDERREQUEST.fields_by_name['direction']._serialized_options = b'\340A\002'
  _POSTSTOPORDERREQUEST.fields_by_name['account_id']._options = None
  _POSTSTOPORDERREQUEST.fields_by_name['account_id']._serialized_options = b'\340A\002'
  _POSTSTOPORDERREQUEST.fields_by_name['expiration_type']._options = None
  _POSTSTOPORDERREQUEST.fields_by_name['expiration_type']._serialized_options = b'\340A\002'
  _POSTSTOPORDERREQUEST.fields_by_name['stop_order_type']._options = None
  _POSTSTOPORDERREQUEST.fields_by_name['stop_order_type']._serialized_options = b'\340A\002'
  _POSTSTOPORDERREQUEST.fields_by_name['instrument_id']._options = None
  _POSTSTOPORDERREQUEST.fields_by_name['instrument_id']._serialized_options = b'\340A\002'
  _GETSTOPORDERSREQUEST.fields_by_name['account_id']._options = None
  _GETSTOPORDERSREQUEST.fields_by_name['account_id']._serialized_options = b'\340A\002'
  _CANCELSTOPORDERREQUEST.fields_by_name['account_id']._options = None
  _CANCELSTOPORDERREQUEST.fields_by_name['account_id']._serialized_options = b'\340A\002'
  _CANCELSTOPORDERREQUEST.fields_by_name['stop_order_id']._options = None
  _CANCELSTOPORDERREQUEST.fields_by_name['stop_order_id']._serialized_options = b'\340A\002'
  _STOPORDERDIRECTION._serialized_start=3385
  _STOPORDERDIRECTION._serialized_end=3504
  _STOPORDEREXPIRATIONTYPE._serialized_start=3507
  _STOPORDEREXPIRATIONTYPE._serialized_end=3672
  _STOPORDERTYPE._serialized_start=3675
  _STOPORDERTYPE._serialized_end=3819
  _STOPORDERSTATUSOPTION._serialized_start=3822
  _STOPORDERSTATUSOPTION._serialized_end=4032
  _EXCHANGEORDERTYPE._serialized_start=4034
  _EXCHANGEORDERTYPE._serialized_end=4153
  _TAKEPROFITTYPE._serialized_start=4155
  _TAKEPROFITTYPE._serialized_end=4266
  _TRAILINGVALUETYPE._serialized_start=4268
  _TRAILINGVALUETYPE._serialized_end=4377
  _TRAILINGSTOPSTATUS._serialized_start=4379
  _TRAILINGSTOPSTATUS._serialized_end=4485
  _POSTSTOPORDERREQUEST._serialized_start=200
  _POSTSTOPORDERREQUEST._serialized_end=1473
  _POSTSTOPORDERREQUEST_TRAILINGDATA._serialized_start=1119
  _POSTSTOPORDERREQUEST_TRAILINGDATA._serialized_end=1423
  _POSTSTOPORDERRESPONSE._serialized_start=1476
  _POSTSTOPORDERRESPONSE._serialized_end=1607
  _GETSTOPORDERSREQUEST._serialized_start=1610
  _GETSTOPORDERSREQUEST._serialized_end=1817
  _GETSTOPORDERSRESPONSE._serialized_start=1819
  _GETSTOPORDERSRESPONSE._serialized_end=1913
  _CANCELSTOPORDERREQUEST._serialized_start=1915
  _CANCELSTOPORDERREQUEST._serialized_end=1992
  _CANCELSTOPORDERRESPONSE._serialized_start=1994
  _CANCELSTOPORDERRESPONSE._serialized_end=2061
  _STOPORDER._serialized_start=2064
  _STOPORDER._serialized_end=3383
  _STOPORDER_TRAILINGDATA._serialized_start=2875
  _STOPORDER_TRAILINGDATA._serialized_end=3383
  _STOPORDERSSERVICE._serialized_start=4488
  _STOPORDERSSERVICE._serialized_end=4936
